...
const Navbar = () => {
  ...
  useEffect(()=>{
    ...
    return (
    <nav className="  fixed top-0 left-0 right-0 z-50 shadow-md p-4 mb-4        flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white  transition-all">
...
<div onClick={()=>navigate("/cart")} className="relative cursor-pointer">
            ...
            {/* Mobile Menu */}
            { open && (
                <div className={`${open ? 'flex' : 'hidden'} relative top-[60px] left-0 w-full bg-white
