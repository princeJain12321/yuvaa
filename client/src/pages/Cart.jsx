...
const Cart = () => {
    ...
    const {products,cartItems,removeFromCart,getCartCount,currency,
    ...
    //     const stripe =await loadStripe("h")
    // }
    useEffect(()=>{
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    ...
                    <p className="flex justify-between text-lg font-medium mt-3">
                        <span>Total Amount:</span><span>{currency}{getCartAmount() * 102 /100}</span>
                    </p>
                </div>

                <button 
                // onClick={()=>{
                //     navigate('/pay');scrollTo(0,0)
                // }}
                onClick={placeOrder}
